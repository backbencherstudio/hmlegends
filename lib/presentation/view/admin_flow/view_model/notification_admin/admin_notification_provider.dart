...
class AdminNotificationProvider extends ChangeNotifier {
  ...
  AdminNotificationModel? get adminNotificationModel => AdminNotificationModel(
    success: true,
    data: _notifications,
  ...
  Future<void> getAdminNotification({String period = 'today'}) async {
    _isLoading = true;
  ...
  Future<void> changePeriod(String period) async {
    await getAdminNotification(period: period);
  }

  /// Re-fetch the current period from the beginning (used by FCM refresh).
  Future<void> refreshNotifications() async {
    await getAdminNotification(period: _currentPeriod);
  }
}
